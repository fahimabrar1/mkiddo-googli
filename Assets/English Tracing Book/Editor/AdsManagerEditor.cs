...
namespace IndieStudio.EnglishTracingBook.Editors
{
    ...
    public class AdsManagerEditor : Editor
    {
        ...
        "https://github.com/ironsource-mobile/Unity-sdk/releases"
    };
...
#if GOOGLE_MOBILE_ADS || LEVELPLAY_DEPENDENCIES_INSTALLED
        ...
        private void ShowInstruction(AdPackage.Package package)
        {
            ...
            else if (package == AdPackage.Package.IRONSOURCE)
            {
                ShowIronSourceInstructions();
            }
        ...
        private void ShowAdmobInstructions()
        {
            ...
            EditorGUILayout.HelpBox("3. Select\n\nAssets > Play Services Resolver > Android Resolver > Resolve/Force Resolve for Android Platform\n" +
                "Assets > Play Services Resolver > iOS Resolver > Install Cocoapods for IOS Platform", MessageType.None);
        ...
        private void ShowIronSourceInstructions()
        {
            EditorGUILayout.HelpBox("1. Import the LevelPlay Unity package to your project", MessageType.None);
            EditorGUILayout.HelpBox("2. Install the adapters of your preferred ad networks using LevelPlay Network Manager", MessageType.None);
            EditorGUILayout.HelpBox("3. Create and configure your app in Unity Services/IronSource web portal", MessageType.None);
            EditorGUILayout.HelpBox("4. Read more details and configurations in the following link ", MessageType.None);
            if (GUILayout.Button("Learn How To Integrate IronSource Sdk", GUILayout.Width(260), GUILayout.Height(20)))
            {
                Application.OpenURL("https://developers.is.com/ironsource-mobile/unity/unity-plugin/#step-1");
            }

            EditorGUILayout.HelpBox("5. Modify the attributes below as you wish", MessageType.None);
            EditorGUILayout.HelpBox("6. Click on Apply button that located on the top to save your changes", MessageType.None);
            EditorGUILayout.HelpBox("7. !important - Once you want to release or publish your app, you need to disable the Test Mode", MessageType.None);
